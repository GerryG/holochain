		...
		zomes := []Zome{
			{
				...
				Functions: []FunctionDef{
					{Name: "getDNA", CallingType: STRING_CALLING, ExposedTo: PUBLIC_EXPOSURE},
					{Name: "addEven", CallingType: STRING_CALLING, ExposedTo: PUBLIC_EXPOSURE},
					{Name: "addPrime", CallingType: JSON_CALLING, ExposedTo: PUBLIC_EXPOSURE},
					{Name: "testStrFn1", CallingType: STRING_CALLING, ExposedTo: PRIVATE_EXPOSURE},
					{Name: "testStrFn2", CallingType: STRING_CALLING, ExposedTo: PUBLIC_EXPOSURE},
					{Name: "testJsonFn1", CallingType: JSON_CALLING, ExposedTo: PUBLIC_EXPOSURE},
					{Name: "testJsonFn2", CallingType: JSON_CALLING, ExposedTo: PRIVATE_EXPOSURE},
				},
			},
			{
				Name:        "jsSampleZome",
